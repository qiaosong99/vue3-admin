 ...
 * @Date: 2023-01-29 20:38:05
 * @LastEditors: qiaosong 920323693@qq.com
 * @LastEditTime: 2023-01-30 10:09:25
 * @FilePath: \newbee-admimn\src\views\OrderDetail.vue
    ...
    >
      <el-table-column label="商品图片">
        <template #default="scope">
          <img :src="$filters.prefix(scope.row.goodsCoverImg)" style="width: 100px" :key="scope.row.goodsId" alt="商品主图">
        </template>
      </el-table-column>
