  ...
  <el-card class="account-container">
    ...
    >
      <el-form-item label="登录名：" prop="loginName">
        <el-input style="width: 200px" v-model="state.nameForm.loginName" />
      </el-form-item>
      <el-form-item label="昵称：" prop="nickName">
        <el-input style="width: 200px" v-model="state.nameForm.nickName" />
      </el-form-item>
      <el-form-item>
  ...
  <el-card class="account-container">
    ...
    >
      <el-form-item label="原密码：" prop="oldpass">
        <el-input v-model="state.nameForm.oldpass"  style="width: 200px"/>
      </el-form-item>
      <el-form-item label="新密码：" prop="newpass">
        <el-input v-model="state.nameForm.newpass" style="width: 200px" />
      </el-form-item>
      <el-form-item>
